...
function fixture(): DemoSnapshotV2 {
  ...
  return {
    schemaVersion: 2, seedVersion: "test", revision: 3, baseAsOfAt: stamp as never, currentAsOfAt: stamp as never, appliedCommandIds: [], appliedScenarioEventIds: [], markets: [], metricDefinitions: [{ id: "M13" as never, version: "v2-frozen-1" as never, unit: "events", description: "Weekly and goal review integrity", timeWindowSemantics: "Explicit weekly window", populationRule: "Canonical review records", attributionRule: "Frozen review scope" }], evidenceSnapshots: [], manualMarketNotes: [],
